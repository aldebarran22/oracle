...
declare
        ...
        l_names vcArray := vcArray( 'owner.pkg.proc@database_link',
                    ...
                    '123' );
   begin
      dbms_output.put_line('numero de nombres: ' || l_names.count);
       /*
       ...
       begin
           ...
           dbms_output.put_line( 'next    ' || l_next || ' ' || length(l_names(i)));
       exception
          when others then
               dbms_output.put_line( 'name    ' || l_names(i) );
